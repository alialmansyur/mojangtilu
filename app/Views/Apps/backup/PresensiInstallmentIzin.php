            ...
            <div class="card-body p-2 px-4">
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-md-6 text-end">
                        <button class="btn btn-outline-primary me-2 mb-2" data-bs-toggle="collapse"
                            data-bs-target="#collapseExample" aria-expanded="false"><i class="bi bi-filter"></i> Filter
                            Data</button>
                        <button class="btn btn-outline-primary me-2 mb-2" data-bs-toggle="modal"
                                    ...
                                    <form method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <a href="/pengajuan-izin" class="btn btn-danger mt-2 me-2"><i
                        ...
                        <table id="exportTable" class="table table-hover table-bordered nowrap dtable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value['leave_init']; ?></td>
                                    <td><?= $value['date_start']; ?></td>
                                    <td><?= $value['time_attend']; ?></td>
                                    <td><span
                                            class="badge badge-dim bg-<?= $value['status_clr']; ?>"><?= $value['status_msg']; ?></span>
                                    </td>
                                    <td><?= $value['approved_at']; ?></td>
                                    <td>
                                        <?php if($value['status'] == 1): ?>
                                        <button class="btn btn-outline-danger btn-sm cancel-installment"
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="date" name="txt_date_1" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-none" id="opt1">
                            <div class="form-group">
                                <div class="form-group">
                                    <label class="form-label">Jenis Izin Manual</label>
                                    <div class="form-control-wrap">
                                        <select class="form-select" name="opt_leave_2">
                                            <option value="">Pilih Salah satu</option>
                                            <option value="Jaringan Server">Jaringan Server</option>
                        ...
                        <div class="col-lg-6 d-none" id="opt2">
                            <div class="form-group">
                                <label class="form-label">Waktu</label>
                                <div class="form-control-wrap">
                                    <input type="time" name="txt_time" class="form-control"
                                        placeholder="Input placeholder" value="<?= date("H:i") ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
...
<script src="<?= base_url('apps/assets/js/custom/presence_installment_izin.js'); ?>"></script>
<?= $this->endSection(); ?>