...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('apps/'); ?>assets/css/main/custom.css?v=5.1">
	...
	<script src="<?= base_url('apps/'); ?>assets/extensions/datatables/datatables.min.js"></script>
	<script src="<?= base_url('apps/'); ?>assets/js/custom/menuactive.js"></script>
