...
// --------------------------------
// 🚀 Konfigurasi Auto Routing
// --------------------------------

// Opsi Autoroute:
// - `true`  : Mengaktifkan autoroute legacy (tidak direkomendasikan untuk produksi)
// - `false` : Menonaktifkan autoroute legacy, hanya bisa menggunakan route yang didefinisikan manual
// - `$routes->setAutoRoute(true);` masih bisa digunakan di CI < 4.2
// - Gunakan AutoRouteImproved jika ingin menggunakan fitur auto-routing yang lebih aman
...
$routes->group('', ['filter' => 'jwtauth'], function ($routes) {
    $routes->get('/home', 'Apps\AppsController::home');
    $routes->get('/sclgn', 'Apps\AppsController::xxx');
    $routes->get('/profil', 'Apps\AppsController::profil');
